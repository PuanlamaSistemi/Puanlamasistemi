...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center">
            <h3 class="text-lg font-bold text-gray-800 mb-4 self-start">Projelere Göre Oy Dağılımı</h3>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center">
            <h3 class="text-lg font-bold text-gray-800 mb-4 self-start">Projelerin Ortalama Puanları</h3>
    ...
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold text-gray-800">Sistemdeki Projeler</h2>
        <a href="export.php" class="bg-emerald-500 text-white px-4 py-2 rounded-lg font-bold shadow-sm hover:bg-emerald-600 transition flex items-center gap-2">
                    ...
                    <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                        ...
                        <td class="p-4 text-right space-x-2">
                            ...
                            <a href="admin_project_details.php?id=<?php echo urlencode($row['id']); ?>"
                                class="inline-block bg-emerald-100 text-emerald-700 px-3 py-1 rounded text-sm hover:bg-emerald-200 transition"
                            ...
                            <a href="<?php echo $q_url; ?>" target="_blank"
                                class="inline-block bg-pink-100 text-pink-700 px-3 py-1 rounded text-sm hover:bg-pink-200 transition"
